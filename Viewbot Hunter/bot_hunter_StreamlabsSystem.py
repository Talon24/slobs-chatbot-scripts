...
def install_selenium():
    ...
    try:
        ...
        # Attempt to get around missing PROTOCOL_TLS in ssl module error?
        # I guess it means it found pip but ironpython did its thing?
        log("If you see this message then I found the PROTOCOL_TLS error, "
            "please let me know of that! :)")
    # Call pip to install selenium
    command = ["-m", "pip", "install", "selenium"]
